...
import { bookDevice, editDevice, deleteDevice } from '../actions/device';
...
export default connect(mapStateToProps, { bookDevice, bookingHistory, editDevice, deleteDevice })(BookSlotComponent);
